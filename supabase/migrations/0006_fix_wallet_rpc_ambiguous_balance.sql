-- Fix ambiguous PL/pgSQL references in wallet RPC return-column names.
-- Preserves Phase 11.1 wallet reserve/refund/spend behavior.
...
comment on function public.spend_reserved_credits(uuid, uuid, integer, text, text) is
  'Atomically spends reserved credits after generation succeeds. Intended for backend worker use.';
